...
<main>
  <div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4 d-flex justify-content-between align-items-center">
      ...
      <li><a href="/admin/manager/news" class="btn btn-primary">Manage Blog</a></li>
    </ol>
    <hr>
        <div class="row justify-content-center">
          ...
          <?php if(session_get("message")) : ?>
            ...
            <input type="hidden" name="id" value="<?= $news['id']?>">
              <!-- Product Name -->
              <div class="mb-3">
                <label for="news_name" class="form-label">Blog Name</label>
              ...
              <!-- Product Image -->
              <div class="mb-3">
                <label for="news_image" class="form-label">Blog Image</label>
