                ...
                <div class="mb-4">
                   ...
                   <h1 class="mt-3" style="font-size: 26px; font-weight: 600"><?= $news['news_title'] ?></h1>
                    ...
                    <div class="container  mt-5">
                       <h3 style="font-size:20px">Share this Post</h3>
                        <div class="d-flex justify-content-left gap-2 mt-3">
                            <a href="#" class="btn btn-facebook" id="facebookShare">
                              ...
                              <a href="https://instagram.com/create/story?media_url=<?= rtrim(getenv('SITE_URL'),'/').'/uploads/'.$news['news_image'] ?>" target="_blank" class="btn btn-instagram">
                        ...
                        ?>
                              <a href="https://pinterest.com/pin/create/button/?url=<?= $base_url. '/'.$route?>&media=<?= $base_url.'/uploads/'.$news['news_image']?>&description=<?= $news['news_title'] ?>" data-pin-do="buttonPin" data-pin-config="above" target="_blank" class="btn btn-pinterest">
